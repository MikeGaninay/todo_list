...
SECRET_KEY = 'your-secret-key'  # ← replace with your real secret in prod
DEBUG = True
...
# CORS: allow Flutter web dev server to talk
...
# Optional: SimpleJWT settings (tweak lifetimes as desired)
